...
## 目指した課題解決
コロナ禍で人間関係が希薄になっている現在。マスクについては自己判断になり、元の日常を取り戻しつつありますが、それでもまだ、人間関係は以前のようなものには戻っていなく、どこか距離感を感じます。
...
## 洗い出した要件
コロナ禍が収まりつつあるが、まだマスクや外に出ることに抵抗を覚えている人がおり、また、人間関係が以前のようにすべてが元通りになったわけでない。
...
## 今後実施したいこと
・Rspecの結合テストの充実。Vue.jsの使用によるSPAの実現。